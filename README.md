...
2.  请直接复制本项目（上游仓库）中 [`.github/workflows/sync.yml`](https://github.com/wuzf/ldc-shop/blob/main/.github/workflows/sync.yml) 的全部内容。
    *   **文件地址**: [https://github.com/wuzf/ldc-shop/blob/main/.github/workflows/sync.yml](https://github.com/wuzf/ldc-shop/blob/main/.github/workflows/sync.yml)
